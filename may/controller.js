...
if(rnd==3){q1=questionBank[questionNumber][2];q2=questionBank[questionNumber][1];}
 ...
 $('.option').click(function(){
  ...
  setTimeout(function(){changeQuestion()},1000);
	...
	function displayFinalSlide(){
		...
		$(stage).append('<div class="questionText">Has terminado el cuestionario!<br><br>Total de preguntas: '+numberOfQuestions+'<br>Respuestas correctas: '+score+'</div>');
